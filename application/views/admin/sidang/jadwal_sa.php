...
// form open
echo form_open(base_url('admin/sidang/save_jadwal_sa/'. $mhs->id_mahasiswa.'/0'),' class="form-horizontal"');
?>

<div class="form-group">
  <label class="col-md-6 control-label">Nama Mahasiswa</label>
  <div class="col-md-6">
    <input type="text" class="form-control nama" placeholder="Nama Pengguna" name="jadwal_sidang" value="<?php echo $mhs->nama_mahasiswa ?>" readonly style="color:black;">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-6">
    <input type="datetime-local" class="form-control inpt-awal" placeholder="Nama Pengguna" name="jadwal_sidang_alat" value=""   onchange="show_selesai()" required>
  </div>
</div>
...
// form open
echo form_open(base_url('admin/sidang/save_jadwal_sa/'. $mhs->id_mahasiswa.'/1'),' class="form-horizontal"');
?>
 ...
 <script>
  function show_selesai(){
    ...
    html += `<label class="col-md-6 control-label">Sidang Selesai</label>
              <div class="col-md-6">
                <input type="datetime-local" class="form-control inpt-selesai" placeholder="Nama Pengguna" name="jadwal_sidang_alat_akhir" value="" onchange="show_ketua()" required>
              </div>`;
  ...
  function show_ketua(){
    ...
    $.ajax({
        type: "POST",
        url: '<?= base_url('admin/sidang/ajax_ketua_sa/')?>'+awal+'/'+akhir,
        dataType: "JSON",
        success: function(data){
          ...
          html += `<label class="col-md-6 control-label">Ketua Penguji</label>
              <div class="col-md-6">
              <select name="ketua_sa" class="form-control ketua" id="ketua" onchange="show_sekre()" required>`;
    ...
    $.ajax({
        ...
        success: function(data){
          ...
          html += `<label class="col-md-6 control-label">Sekretaris Penguji</label>
              <div class="col-md-6">
              <select name="sekre_sa" class="form-control" onchange="show_submit()" required>`;
          html +=`<option value="">-=Pilih Dosen=-</option>`;
          for (i = 0; i < data.length; i++) {
