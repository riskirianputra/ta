                ...
                <table class="table table-bordered text-center">
                    ...
                    <tr>
                        ...
                        <tr>
                            <td></td>
                            <td>a.Penampilan</td>
                            <td><?=$nilai_p1->penampilan_kompre?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>b.Presentasi</td>
                            <td><?=$nilai_p1->presentasi_kompre?></td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>Penguasaan Tugas Akhir</td>
                            <td><?=$nilai_p1->penguasaan_kompre?></td>
                        </tr>
                        <tr>
                            <td>3</td>
                            <td>Penulisan Tugas Akhir</td>
                            <td><?=$nilai_p1->penulisan_kompre?></td>
                        </tr>
                        <tr>
                            <td>4</td>
                            <td>Wawasan</td>
                            <td><?=$nilai_p1->wawasan_kompre?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td><b>TOTAL</b></td>
                            <td><?=$nilai_p1->total_nilai_kompre?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
        </div>
        <div class="text-center" style="margin-top:10px;margin-bottom:50px;margin-left: 410px;font-family:serif;">
                ...
                <table class="table table-bordered text-center">
                    ...
                    <tr>
                        ...
                        <tr>
                            <td></td>
                            <td>a.Penampilan</td>
                            <td><?=$nilai_p2->penampilan_kompre?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>b.Presentasi</td>
                            <td><?=$nilai_p2->presentasi_kompre?></td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>Penguasaan Tugas Akhir</td>
                            <td><?=$nilai_p2->penguasaan_kompre?></td>
                        </tr>
                        <tr>
                            <td>3</td>
                            <td>Penulisan Tugas Akhir</td>
                            <td><?=$nilai_p2->penulisan_kompre?></td>
                        </tr>
                        <tr>
                            <td>4</td>
                            <td>Wawasan</td>
                            <td><?=$nilai_p2->wawasan_kompre?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td><b>TOTAL</b></td>
                            <td><?=$nilai_p2->total_nilai_kompre?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
        </div>
        <div class="text-center" style="margin-top:10px;margin-bottom:70px;margin-left: 410px;font-family:serif;">
            <p>Payakumbuh <?= date('d F Y')?></p>
            <p><b>PENGUJI II</b></p>
            <br>
            <br>
                ...
                <table class="table table-bordered text-center">
                    ...
                    <tr>
                        ...
                        <tr>
                            <td></td>
                            <td>a.Penampilan</td>
                            <td><?=$nilai_p3->penampilan_kompre?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>b.Presentasi</td>
                            <td><?=$nilai_p3->presentasi_kompre?></td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>Penguasaan Tugas Akhir</td>
                            <td><?=$nilai_p3->penguasaan_kompre?></td>
                        </tr>
                        <tr>
                            <td>3</td>
                            <td>Penulisan Tugas Akhir</td>
                            <td><?=$nilai_p3->penulisan_kompre?></td>
                        </tr>
                        <tr>
                            <td>4</td>
                            <td>Wawasan</td>
                            <td><?=$nilai_p3->wawasan_kompre?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td><b>TOTAL</b></td>
                            <td><?=$nilai_p3->total_nilai_kompre?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<!-- ======================================== Halaman 4 =============================================== -->
        ...
        <HR style="margin-top: -17px;border-top: 1px solid #000;"></HR>
        <div class="text-center">
        <h4><b>REKAPITULASI NILAI UJIAN TUGAS AKHIR MAHASISWA</b></h4>
        <h4><b>PROGRAM STUDI D3 TEKNIK KOMPUTER</b></h4>
        <hr>
        </div>
        <div class="text-left" style="margin-left:200px">
        <h5>Nama&nbsp; : <?=strtoupper($nilai_p2->nama_mahasiswa)?></h5>
        <h5>NPM&nbsp;&nbsp;&nbsp; : <?=($nilai_p2->no_induk)?></h5>
        <h5>Judul : <?=$nilai_p2->judul_ta?></h5>
        </div>
        <br>
        <div class="text-center" style="padding-left: 100px;padding-right: 100px;">
            <div class="table-responsive">
                <table class="table table-bordered text-center">
                    ...
                    <?php 
                        $total_nilai = $nilai_p1->total_nilai_kompre + $nilai_p2->total_nilai_kompre + $nilai_p3->total_nilai_kompre;
                        $nilai_rata = $total_nilai / 3;
                    ?>
                    <tbody>
                        <tr>
                            <td>NILAI PENGUJI I</td>
                            <td><?= $nilai_p1->total_nilai_kompre ?></td>
                        </tr>
                        <tr>
                            <td>NILAI PENGUJI II</td>
                            <td><?= $nilai_p2->total_nilai_kompre ?></td>
                        </tr>
                        <tr>
                            <td>NILAI PENGUJI III</td>
                            <td><?= $nilai_p3->total_nilai_kompre ?></td>
                        </tr>
                        <tr>
                            <td>TOTAL NILAI</td>
...
<!-- ===================================== HALAMAN 5 ============================================= -->
        ...
        <HR style="margin-top: -17px;border-top: 1px solid #000;"></HR>
        <div class="text-center">
        <h4><b>BERITA ACARA UJIAN TUGAS AKHIR MAHASISWA</b></h4>
        <h4><b>PROGRAM STUDI TEKNIK KOMPUTER</b></h4>
        <hr>
        ...
        <h5>Nama&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?=strtoupper($nilai_p2->nama_mahasiswa)?></h5>
        <h5>NPM&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?=($nilai_p2->no_induk)?></h5>
        <h5>Judul Tugas Akhir : <?=strtoupper($nilai_p2->judul_ta)?></h5>
        </div>
